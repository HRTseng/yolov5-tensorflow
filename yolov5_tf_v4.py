...
def post_process(inputs,grids,strides,anchor_grid,class_num):
    ...
    indices=tf.image.non_max_suppression(boxes,scores,max_output_size=3000,iou_threshold=0.45,score_threshold=0.01)
...
if __name__=="__main__":
    ...
    anchors = [[10,13, 16,30, 33,23],#14,19,23,43,48,33
               [30,61, 62,45, 59,119],#43,89,90,65,86,173
               [116,90, 156,198, 373,326]]#169,131,228,289,545,476
